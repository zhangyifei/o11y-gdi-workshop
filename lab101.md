...
docker build -f ubuntu-image/mac-m1.dockerfile -t ubuntu-macm1-systemd:latest .
docker run -d --name docker-${USER} --rm -p 4317:4317 -p 55679:55679 -p 9411:9411 --tmpfs /tmp --tmpfs /run --tmpfs /run/lock -v /sys/fs/cgroup:/sys/fs/cgroup:ro -t ubuntu-macm1-systemd
docker run -t -d --privileged -v /sys/fs/cgroup:/sys/fs/cgroup --name docker-${USER} --rm -p 4317:4317 -p 55679:55679 -p 9411:9411 ubuntu-macm1-systemd
